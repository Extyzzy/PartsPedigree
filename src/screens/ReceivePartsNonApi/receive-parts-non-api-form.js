...
export class ReceivePartsNonApiForm extends CommonForm<Props> {
    ...
    validateOrganization(): boolean {
        return this.validateField('fromOrganizationId', 'Organization');
    }
    ...
    selectOrganization(organizationId) {
        this.setValue('fromOrganizationId', organizationId);
        this.validateOrganization();
        ...
        return (
            <View>
                ...
                <Picker
                    ...
                    selected={this.state.model.fromOrganizationId}
                    onSelect={({title, value}) => this.selectOrganization(value)}
                ...
                <View style={[commonStyle.flexRow, commonStyle.marginHorizontal(-5)]}>
                    <View style={[commonStyle.flex(0.7), commonStyle.paddingHorizontal(5)]}>
                        <TextInputValid
                            ...
                            style={[commonStyle.input, commonStyle.colorBlack, style.text]}
                            autoCapitalize="none"
                            onChangeText={value => {this.setValue(weightField, value, true); this.props.setTotalWeight(value)}}
                            //onBlur={() => validFn && validFn.call(this)}
